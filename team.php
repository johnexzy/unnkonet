...
<div class="mainsub">
        	...
        	<ul id="submenu" style="">
                <li  color="black"><a href="index.php"><i class="icon-home"></i> HOME</a></li>
                <li><a href="pricing.php"><i class="icon-credit-card">&nbsp;</i> PRICING TAble</a></li>
                <li title="Birthday signup" ><a href="birthdaysignup.html"><i class="icon-calendar">&nbsp;</i> birthday signup</a></li>
                <li title="view older posts" ><a href="timeline.php"><i class="icon-tags">&nbsp;</i> news timeline</a></li>
                <li title="Calculate your Gp" ><a href="GPA_CALC.html"><i class="icon-star">&nbsp;</i> GP CAlculator</a></li>
                <li title="Wise sayings" ><a href="testimonials.html"><i class="icon-lightbulb">&nbsp;</i> Wise sayings</a></li>
                <li title="Unnkonet Gallery" ><a href="gallery.html"><i class="icon-picture">&nbsp;</i> Gallery</a></li>
                <li class="active" title="Team page" ><a href="team.php"><i class="icon-group">&nbsp;</i> Team</a></li>
        	...
        	<div class="row space-bot" style="height: 150px;">
        		...
        		<div class="c8 right">
        			...
        			<ul id="responsivemenu">
        				<li><a href="index.php">HOME<span class="showmobile"></span></a></li>
...
<div class="undermenuarea">
	...
	<div class="grid">
		<div class="row">
			<div class="c8">
				<h1 class="titlehead">MEET THE MANAGEMENTS</h1>
			</div>
			<div class="c4">
