...
<title>UNN KONET::<?php echo $headline ?></title>
<!--
	======= FAVICON IMAGE
-->
...
<div class="boxedshadow">
	...
	<div class="grid">
		<div class="row">
			<div class="c8">
				<h1 class="titlehead" ><?php //echo $headline ?></h1>
			</div>
			<div class="c4">
...
<div class="grid">
		...
		<div class="row">
			<div class="c12">
				<h1 class="maintitle ">
				<span id="headline"><?php echo $headline ?> </span>
				</h1>
			</div>
		</div>
		<div class="row">
                    ...
                    <div class="flexslider">
                        <ul class="slides">
                            <li style="display: list-item;">
                                <img src="../../admin/homepages/<?php echo $uploads ?>" alt="hello">
                            </li>
                        </ul>
                    </div>
