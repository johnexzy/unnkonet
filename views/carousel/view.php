...
<div class="mainsub">
	...
	<ul id="submenu" style="">
        ...
        <li title="WISE SAYING" ><a href="../../testimonials.html"><i class="icon-lightbulb">&nbsp;</i> Wise sayings</a></li>
        <li title="GALLERY" ><a target='_blank' href="../../gallery.html"><i class="icon-picture">&nbsp;</i> Gallery</a></li>
...
<div class="grid">
		...
		<div class="row">
            ...
            <h1 class="maintitle text-center">
                ...
                <!-- <ul class="social-links" style="width:250px; margin:0 auto;display:block">
                ...
                <!-- <input type="hidden" id='postlink' value="http://localhost/www/unnkonet/views/news/view.php?id=<?php //echo $id ?>"> -->
            </div>
        ...
        const SharePost = ()=>{
            if(navigator.share){
               //alert(phead)
                ...
                alert('Web Share not suprted. Try Sharing Manually');
            }
        };
    </script>
