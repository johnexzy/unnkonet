<?php
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC)){
			...
			$display_string .= "<form action='views/carousel/view.php' enctype='multipart/form-data' method='GET'>";
			...
			$display_string .= "<a href='views/carousel/view.php?id=$row[id]&getpage=read+more'><img style='border-radius:20px' src='admin/homepages/$row[image]'></a>";
			$display_string .= "</div>";
			$display_string .= "</form>";
			$display_string .= "</li>";
		}
