		...
		================================================== -->
			...
			<div class="mainsub">
				...
				<ul id="submenu" style="">
					...
					<li><a href="timeline.php" ><i class="icon-group">&nbsp;</i> Timeline</a>
					<li><a href="pricing.php"><i class="icon-credit-card">&nbsp;</i> PRICING TAble</a></li>
					<li title="Contact Us" ><a target='_blank' href="contact.html"><i class="icon-calendar">&nbsp;</i> birthday signup</a></li>
					<li title="Contact Us" ><a href="contact.html"><i class="icon-tags">&nbsp;</i> news timeline</a></li>
					<li title="Contact Us" ><a target='_blank' href="contact.html"><i class="icon-star">&nbsp;</i> GP CAlculator</a></li>
					<li title="Contact Us" ><a href="contact.html"><i class="icon-lightbulb">&nbsp;</i> Wise sayings</a></li>
					<li title="Contact Us" ><a target='_blank' href="contact.html"><i class="icon-picture">&nbsp;</i> Gallery</a></li>
			...
			================================================== -->
				<div class="grid">
					...
					</div> <a href="birthdaysignup.html"><div style='text-align:center; margin:30px 0 30px 0'><div class='actionbutton'> Let's Celebrate with you. Add Your birthday</div></div></a>
				</div>
				<!-- CALL TO ACTION
				================================================== -->
				<div class="row space-bot">
