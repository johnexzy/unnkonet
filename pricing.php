...
<div class="mainsub">
        	...
        	<ul id="submenu" style="">
                ...
                <li class="active"><a href="pricing.php"><i class="icon-credit-card">&nbsp;</i> PRICING TAble</a></li>
        	...
        	<div class="row space-bot" style="height: 150px;">
        		...
        		<div class="c8 right">
        			...
        			<ul id="responsivemenu">
        				...
        				<li class="active"><a href="pricing.php">PRICING TABLE</a>
...
<div class="grid">
		<div class="shadowundertop">
			...
			<div class="c12">
				<h1 class="maintitle ">
				<span>Pricing Style for adverts</span>
				</h1>
				<!-- begin pricing style 1 -->
				<div id="pricing-table" class="clear">
					<?php include 'php/showprice.php'; ?>
				</div>
